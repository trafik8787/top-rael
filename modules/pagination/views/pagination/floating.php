...
<ul class="pagination">
	...
	<?php if ($first_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($first_page)) ?>">&laquo;</a></li>
...
<!--	--><?php //endif ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php if ($number === $current_page): ?>
			<li class="active"><a href="#"><?php echo $content ?> <span class="sr-only">(current)</span></a></li>
...
<!--	--><?php //endif ?>
	...
	<?php if ($last_page !== FALSE): ?>
		<li><a href="<?php echo HTML::chars($page->url($last_page)) ?>">&raquo;</a></li>
