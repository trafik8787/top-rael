                ...
                <div class="recomendation">
                    ...
                    <div class="recomendation-icons">
                        ...
                        <div class="text-center">
                            <a class="w-icon-mail" href="mailto:?Subject=  <?=$data['BusName']?>, &body=<?= Request::full_current_url()?> <?=$data['BusName']?> <?=Text::limit_chars(strip_tags($data['BusInfo']), 150, null, true)?>">
                                <span></span>
                            </a>
                            ...
                            <a href="https://vk.com/share.php?url=<?= urlencode(  Request::full_current_url() ); ?>"><span class="social vk"><i class="fa fa-vk"></i></span></a>
